...
//     onst [mySoc, setMySoc] = useState(null);
...
// {/* THIS IS THE MODAL FOR WHEN U CLICK TRACK OPTIONS */}
...
export default function Home() {
  ...
  const HandleUpdateTrack = (id, trackdata) => {
    ...
    //props from tracks info comp need to be set here from teh data passed as track data
    dndtrack[id] = {
      ...dndtrack[id],
      ...trackdata
          ...
          <DndProvider backend={TouchBackend} options={{
            ...
            <TrackScoll>
              ...
              {tracks.map((o, i) => <MyTrack
                ...
                //needs to pass over track data to drop zone
                onUpdateTrack={(obj) => HandleUpdateTrack(o.id, o, obj)}
                song={o.Title}
                album={o.Album}
                time={((o.duration_ms / 1000) / 60).toFixed(2)}
              />)}
